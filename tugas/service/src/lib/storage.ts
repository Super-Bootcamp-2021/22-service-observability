...
function randomFileName(mimetype: any): string {
  return (
    new Date().getTime() +
    '-' +
...
export function saveFile(file: any, mimetype: any): Promise<any> {
...
export async function readFile(objectName): Promise<any> {
  if (!objectName) {
